    ...
    <div className='mt-10 max-w-6xl mx-auto mb-5 '>
      {
        cartItem.length > 0 ? <div>
              ...
              <div className='bg-gray-100 rounded-md p-7 mt-4 space-y-2'>
                ...
                <div className='flex w-full gap-5'>
                  ...
                  <div className='flex flex-col space-y-1 w-full'>
                    ...
                    <input type="tel" placeholder='Enter your Number' className='p-2 rounded-md w-full' />
                  </div>
                </div>
                <button className='bg-red-500 text-white px-3 py-1 rounded-md mt-3 cursor-poi'>Submit</button>
          ...
          <h1 className='text-red-500/80 font-bold text-2xl text-muted'>Oh no! Your cart is empty</h1>
