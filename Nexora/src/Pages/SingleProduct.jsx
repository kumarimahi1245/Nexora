              ...
              <div className='text-gray-700'>{SingleProduct.brand?.toUpperCase()} / {SingleProduct.category?.toUpperCase()} /
                ...
                <p className = "text-xl text-red-500 font-bold ">Rs.{SingleProduct.price} 
                  ...
                  <div className='flex items-center gap-4'>
                    ...
                    <input type="number" min={1} value={1} className='w-20 border-gray-300 rounded-lg px-3 py-1 focus:outline-none
                    focus-ring-2 focus-ring-red-500'/>
                  </div>
                  
                  <div className='flex gap-4 mt-4'>
                    <button className='px-6 flex gap-2 py-2 text-lg bg-red-500 text-white' onClick={()=>addToCart(SingleProduct)}>
